...
<input type="text" id="comune" name="comune" class='form-control' placeholder="<?php printf($i); ?>" required>
<label for="comune"><?php printf($c); ?></label>
</div>
<button id="button_comune"><?php printf($b); ?></button>
</div>
